...
public class ScanAfterDialog extends AppCompatActivity implements ReaderCallback {
    ...
    String Storecode,Stocktype,Areatype,Floortype,Ecode;
    ...
    String Gandolacode = null;
    ArrayList<String>  export = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scan_after_dialog);
        ...
        gandola = dbController.getallstorevalue();
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (export.size() == 0)
                {
                    Toast.makeText(ScanAfterDialog.this, "No Data to Export", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        Manualbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ScanAfterDialog.this, "Please Add Hu", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    bundle.putString("Floortype",Floortype);
                    bundle.putString("Ecode",Ecode);
    ...
    public class Exportgandolascanning extends AsyncTask<String, Void, Boolean> {
        ...
        private final ProgressDialog dialog = new ProgressDialog(ScanAfterDialog.this);
...
//        String csvname = GandolaNo.getText().toString();
        ...
        protected void onPreExecute() {
            ...
            this.dialog.show();
            dbhelper = new DBController(ScanAfterDialog.this);
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Toast.makeText(ScanAfterDialog.this, "Export successful!", Toast.LENGTH_SHORT).show();

                clearfield();
            } else {
                Toast.makeText(ScanAfterDialog.this, "No Gandola file Recieved", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public  void  databaseoperation(String Barcodeno)
    {
        ...
        try
        {
            ...
            if (duplicatebarcode.size() >= 1)
            {
                ...
                Toast.makeText(ScanAfterDialog.this, newqty, Toast.LENGTH_SHORT).show();
